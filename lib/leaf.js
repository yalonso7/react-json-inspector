    ...
    render: function() {
        ...
        return React.createElement('div', { className: this.getClassName(), id: 'leaf-' + this._rootPath() },
          ...
          React.createElement('label', { className: 'json-inspector__line', htmlFor: id, onClick: this.toggle },
            ...
            React.createElement('span', { className: isLeaf(dataType) ? 'json-inspector__leafKey' : 'json-inspector__key',
                onClick: isLeaf(dataType) ? onLabelClick : undefined },
              this.format(d.key),
              ':',
